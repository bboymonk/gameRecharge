...
function genderOpt() {
    return [
        ' <a id="edit" href="javascript:void(0)"  class="btn btn-primary  btn-xs" ><i class="fa fa-edit"></i> 修改</a>',
        ' <a  id="remove" href="javascript:void(0)"    class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> 删除</a>'  ].join('');
}
